...
export default async function home() {
  ...
  return (
    <div>
      <h1 className="flex flex-col items-center h-[50px] justify-center m-4 bg-sky-600 text-white"> America countries</h1>
      ...
      <footer className="flex flex-col items-center h-[50px] justify-center m-4 bg-sky-600 text-white">
        <p>{`we have ${countries.length} countries in South Americas`}</p>
      </footer>
    </div>
  )
}